...
namespace CapaPresentacion
{
    public partial class frmCobroDelivery : Form
    {
        ...
        private void ocultarColumnas()
        {
            ...
            this.dataListado.Columns[3].Width = 340;
            this.dataListado.Columns[4].Width = 93;
            this.dataListado.Columns[5].Width = 93;
            this.dataListado.Columns[6].Width = 93;
            this.dataListado.Columns[7].Width = 145;
            this.dataListado.Columns[13].Width = 145;
        ...
        private void frmCobroDelivery_Click(object sender, EventArgs e)
        {
